...
public class Croller extends View {
    ...
    private void initXMLAttrs(Context context, AttributeSet attrs) {
        ...
        setLabelSize(a.getDimension(R.styleable.Croller_label_size, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, labelSize, getResources().getDisplayMetrics())));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isContinuous) {
            ...
            if (isEnabled) circlePaint.setColor(mainCircleColor);
            else circlePaint.setColor(mainCircleDisabledColor);
    ...
    public void setLabelFont(String labelFont) {
        ...
        if (textPaint != null) generateTypeface();
        invalidate();
    }
