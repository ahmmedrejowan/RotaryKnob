...
public class Croller2 extends View {
    ...
    private Paint circlePaint, circlePaint2, linePaint;
    private float currdeg = 0, degree = 3, downdeg = 0;
    ...
    private OnCrollerChangeListener2 mCrollerChangeListener;
    ...
    public void setOnCrollerChangeListener(OnCrollerChangeListener2 mCrollerChangeListener) {
    ...
    public Croller2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initXMLAttrs(context, attrs);
        init();
    }

    public Croller2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgressChangeListener != null)
            mProgressChangeListener.onProgressChanged((int) (degree - 2));

        if (mCrollerChangeListener != null)
            mCrollerChangeListener.onProgressChanged(this, (int) (degree - 2));
        ...
        float x, y;
        float deg2 = Math.max(3, degree);
        float deg3 = Math.min(degree, max + 2);
        ...
        float tmp2 = ((float) startOffset2 / 360) + ((float) sweepAngle / 360) * degree / (max + 5);
